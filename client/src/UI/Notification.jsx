...
function Notification({
  ...
  return (
    <Dialog open={open} handler={close} dir="rtl" className="darkModeMiddle ">
      <DialogHeader className="flex justify-between items-center rounded-md darkModeMiddle">
      ...
      <DialogBody className="text-gray-700 dark:text-white">
        ...
        به تاریخ{" "}
        <span className="font-thin text-sm text-gray-800 dark:text-gray-300">
          {" "}
          {createdDate}
        </span>{" "}
        ...
        <span className="font-thin text-sm  text-green-500">{price}</span> را
        تحویل ماید.
      </DialogBody>
    </Dialog>
  );
